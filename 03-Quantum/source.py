...
if __name__ == '__main__':
    # p, q = getPrime(1024), getPrime(1024)     # VERSION CONTROL: Security vulnerability located. Fix applied.
    p, q = getPrime(2048), getPrime(2048)
    N = p * q
    # e = 65537                                 # VERSION CONTROL: Security vulnerability located. Fix applied.
    # e = getPrime(1024)                        # VERSION CONTROL: Security vulnerability located. Fix applied again.    
    e = getPrime(2048)
    d = pow(e, -1, (p - 1) * (q - 1))

    # TODO: Start the watchdog timer here. CFO wants this script to exit after 1 second.
        ...
        try:
            ...
            if choice == 1:
                ...
                if m == incriminating_message:
                    ...
                    print(f'MESSAGE FROM ENGINEERING TEAM: This is redacted for security reasons.')
            elif choice == 3:
                print('Bye!')
                break
            else:
